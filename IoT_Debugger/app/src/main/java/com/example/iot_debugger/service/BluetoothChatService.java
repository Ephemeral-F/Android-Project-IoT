 ...
 */
package com.example.iot_debugger.service;
...
import com.example.iot_debugger.activity.BlueActivity;
...
public class BluetoothChatService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BlueActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        //将连接的设备的名称发送回UI活动
        Message msg = mHandler.obtainMessage(BlueActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BlueActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        // 将失败消息发送回活动
        Message msg = mHandler.obtainMessage(BlueActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueActivity.TOAST, "无法连接设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BlueActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueActivity.TOAST, "丢失设备连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run()
        {
            ...
            while (true) {  
                try {  
                    ...
                    mHandler.obtainMessage(BlueActivity.MESSAGE_READ, bytes, -1, buffer)
        ...
        public void write(byte[] buffer) {
            try {
                ...
                //将发送的消息共享回UI活动
                mHandler.obtainMessage(BlueActivity.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
